...
if opt.epoch != 0:
    ...
    #Don't Forget To Remove True, This is Only for one Time Use Only!!!
    if True:
        generator.load_state_dict(torch.load("/home/adias/projects/def-mahsa77/8K_January2021/saved_models/generator_%d.pth" % opt.epoch))
        discriminator.load_state_dict(torch.load("/home/adias/projects/def-mahsa77/8K_January2021/saved_models/discriminator_%d.pth" % opt.epoch))        
    else:
        generator.load_state_dict(torch.load("/home/adias/projects/def-mahsa77/8K_January2021/saved_models_dias/generator_%d.pth" % opt.epoch))
        discriminator.load_state_dict(torch.load("/home/adias/projects/def-mahsa77/8K_January2021/saved_models_dias/discriminator_%d.pth" % opt.epoch))
...
for epoch in range(opt.epoch, opt.n_epochs):
    for i, imgs in enumerate(dataloader):
        ...
        if batches_done % opt.checkpoint_interval == 0:
            ...
            torch.save(generator.state_dict(), "/home/adias/projects/def-mahsa77/8K_January2021/saved_models_dias/generator_%d.pth" % epoch)
            torch.save(discriminator.state_dict(), "/home/adias/projects/def-mahsa77/8K_January2021/saved_models_dias/discriminator_%d.pth" % epoch)